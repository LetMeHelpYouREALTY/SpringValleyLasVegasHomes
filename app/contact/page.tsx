...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact Dr. Jan Duffy at Berkshire Hathaway HomeServices Nevada Properties. Office map, Calendly, and (702) 664-8424.",
  keywords: [
        ...
        <div className="container mx-auto px-4">
          {zipFromQuery && (
            ...
            >
              <p className="text-sm font-medium">
                You arrived from a zip search: <strong>{zipFromQuery}</strong>.
                Mention this zip when you call or email so we can tailor
                listings.
              </p>
              {mailtoZip && (
                <a
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Questions about Las Vegas real estate? Reach{" "}
              <strong>Berkshire Hathaway HomeServices</strong> agent{" "}
              {teamInfo.teamLeader.name}. Schedule an appointment or get in
              touch below.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <p className="text-slate-700 mb-8">
                ...
                property, or exploring investment opportunities, our team
                provides expert guidance backed by the trusted{" "}
