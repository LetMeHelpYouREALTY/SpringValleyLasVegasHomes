...
const popularSearches = [
  ...
  },
  {
    ...
    href: "https://www.searchforhomesinhenderson.com/",
    count: "980+",
  },
  {
    name: "Green Valley",
    href: "https://www.greenvalleyranchinsider.com/",
    count: "450+",
  },
  {
    name: "The Ridges Luxury",
    href: "https://www.theridgessummerlinhomes.com/",
    count: "85+",
  },
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {popularSearches.map((search) => {
                ...
                if (search.href.startsWith("http")) {
                  return (
                    <a
                      key={search.name}
                      href={search.href}
