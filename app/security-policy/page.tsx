        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>
                  <strong>Phone:</strong>{' '}
                  <a href="tel:+17026648424" className="underline">
                    (702) 664-8424
                  </a>
                </li>
                <li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>
                <strong>MLS home search (RealScout):</strong> Live listings and search widgets on
                this site; IDX-compliant property data
              </li>
              <li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Ensure you're on the correct domain: <strong>{siteHost}</strong></li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p>
                Phone:{' '}
                <a href="tel:+17026648424" className="text-blue-600 underline">
                  (702) 664-8424
                </a>
              </p>
            </div>
