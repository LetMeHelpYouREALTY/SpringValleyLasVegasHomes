        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {buyerTypes.map((type) => {
                const className =
                  "bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg hover:border-blue-300 transition-all group";
                const inner = (
                  <>
                ...
                return (
                  <Link key={type.href} href={type.href} className={className}>
                    {inner}
                  </Link>
                );
              })}
